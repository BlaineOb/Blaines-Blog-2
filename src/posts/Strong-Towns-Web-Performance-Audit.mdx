...
import pageSpeedCapture from "../assets/StrongTownsAudit/ST_PageSpeed_Insights.png";
import treoCapture from "../assets/StrongTownsAudit/ST_Treo.png";
import speedHubCapture from "../assets/StrongTownsAudit/ST_SpeedHub1.png";
import preloadLCP from "../assets/StrongTownsAudit/ST_Preload_LCP_IMG.png";
import removeHidden from "../assets/StrongTownsAudit/ST_Remove_Hidden.png";
...
<Image src={pageSpeedCapture} alt="PageSpeed Insights showing Core Web Vitals for StrongTowns.org for mobile users." loading="eager" fetchpriority="high" decoding="sync" width="880" height="518"/>
...
<Image src={treoCapture} alt="Treo site speed audit for StrongTowns.org, FCP/LCP" width="880" height="535"/>
...
Insights as "before", and the minimum time to achieve a "good" LCP as "after"(2.5 seconds)<sup id="footnote-ref-1">[1](#footnote1)</sup>: <Image src={speedHubCapture} alt="SpeedHub showing the business metrics improved by increasing 'Page Speed'" width="880" height="408"/>
...
slow connection/device. <Image src={preloadLCP} alt="Capture of network request for the pre-loaded LCP image during a DebugBear test" width="880" height="87"/>
...
a slow connection: <Image src={removeHidden} alt="Capture of a filmstrip showing the difference between hiding the page with CSS and not" width="880" height="464"/>
