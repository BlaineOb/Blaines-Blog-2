...
<Image src={pageSpeedCapture} alt="PageSpeed Insights showing Core Web Vitals for StrongTowns.org for mobile users."
layout="constrained" width={989} height={582} loading="eager" fetchpriority="high"/>
